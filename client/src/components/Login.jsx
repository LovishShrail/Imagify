        ...
        backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            ...
            >
                ...
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                    <img className='-ml-1' src={assets.profile_icon} alt="" width={23} />
                    <input onChange={e => setName(e.target.value)} value={name} 
                    className='outline-none text-sm -ml-1' type="text" placeholder='Full Name' required />
                </div>}
                ...
                <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                    <img className='mr-1' src={assets.lock_icon} alt="" />
                    <input onChange={e => setPassword(e.target.value)} value={password} 
                    className='outline-none text-sm' type="password" placeholder='Password' />
                </div>
